...
Func _SOTN_Tool_Init()
    ...
    Sleep(3000)
    ControlClick("", "", "[NAME:btnMusic]"); removes annoying music
...
#ce Needs to complete a way to get current element tolerance and store it to a array to be used on Randomize attributes.
; Currently is randomizing everything without taking consideration previous tolerance levels. to be able to add "tolerance levels" , its necessary to be able to store current randomization levels
